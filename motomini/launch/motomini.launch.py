...
def generate_launch_description():
    ...
    nodes = [
       ...
       Node(
        ...
        Node(
            ...
            parameters=[*common_params, LaunchConfiguration("collision_yaml_file")],
   ...
   # 6. Controller Manager & Spawners (Conditional)
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("collision_yaml_file", default_value=PathJoinSubstitution([FindPackageShare("robot_planning"), "config", "collision_wrench.yaml"])),
